...
import type { RateCard, SelectOption } from '../../types'
...
const emptyForm: RateCardForm = { name: '', currency: 'USD', effectiveFrom: '', effectiveTo: '' }

const statusLabels: Record<string, string> = { draft: '草稿', active: '生效中', archived: '已归档' }
...
export default function RateCardList() {
  ...
  const { data, loading, error, refetch } = useApi<RateCard[]>(
  ...
  const set = (field: keyof RateCardForm) => (e: ChangeEvent<HTMLInputElement | HTMLSelectElement>) =>
